...
class ProfileTestClass(TestCase):
    def setUp(self):
        ...
        self.user.save()
        self.profile=Profile(user=self.user,name='celine',bio='cool',profile_pic='default.png')
    def tearDown(self):
...
class PostTestClass(TestCase):
    def setUp(self):
        ...
        self.user.save()
        self.profile=Profile(user=self.user,name='celine',bio='cool',profile_pic='default.png')
        self.post=Post(id=1,image='default.png',title='Ninja',description='A picture of a cool bike',user=self.profile)
    def tearDown(self):
